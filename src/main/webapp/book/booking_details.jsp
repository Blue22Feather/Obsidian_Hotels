...
<html>
    ...
    <body class="theme-dark">
        <%
            ...
            int raw_roomTotalPrice = gestion_form.roomTotalPrice(raw_roomType, raw_hotelName, stayLenght);
            String roomTotalPrice = gestion_form.priceFormat(raw_roomTotalPrice);

            String roomBeds = gestion_form.findDataDouble("room_beds", "rooms", "room_type", raw_roomType, "hotel_id", raw_hotelName);
            String roomSpace = gestion_form.findDataDouble("room_area", "rooms", "room_type", raw_roomType, "hotel_id", raw_hotelName);
                ...
                <div class="page has-right-rail">
                    <main class="page__main has" lang="es">
                        ...
                        <div class="page__content">
                            ...
                            <form id="book-form__base" action="./booking_payment.jsp" class="PageBox multi-contents-vert">
                                    ...
                                    <div class="booking__details">
                                        ...
                                        <div class="booking__input-row-double">
                                            <div>
                                                ...
                                                <section>
                                                    <input id="text-1" maxlength="40" name="guest_name" type="text">
                                                    <label for="text-1">
                                                        <svg class="icon">
                                            ...
                                            <div>
                                                ...
                                                <section>
                                                    <input id="text-2" maxlength="40" name="guest_lastname" type="text">
                                                    <label for="text-2">
                                                        <svg class="icon">
                                        ...
                                        <div class="booking__input-row-double">
                                            <div>
                                                ...
                                                <section>
                                                    <input id="text-3" maxlength="80" name="guest_email" type="text">
                                                    <label for="text-3">
                                                        <svg class="icon">
                                            ...
                                            <div>
                                                ...
                                                <section>
                                                    <input id="text-4" name="guest_phoneNumber" type="text" maxlength="10">
                                                    <label for="text-4">
                                                        <svg class="icon">
                                    ...
                                    <div class="extras__wrapper">
                                        <div class="extras__card">
                                            <div class="card__summary">
                                                ...
                                                <section>
                                                    <svg class="icon">
                                                        <use xlink:href="../assets/svg-resources.xml#icon-hearts"></use>
                                                    </svg>
                                                </section>
                                                <div>
                                                    <h2>
                                        ...
                                        <div class="extras__card">
                                            <div class="card__summary">
                                                ...
                                                <section>
                                                    <svg class="icon">
                                                        <use xlink:href="../assets/svg-resources.xml#icon-exercise"></use>
                                                    </svg>
                                                </section>
                                                <div>
                                                    <h2>
                                        ...
                                        <div class="extras__card">
                                            <div class="card__summary">
                                                ...
                                                <section>
                                                    <svg class="icon">
                                                        <use xlink:href="../assets/svg-resources.xml#icon-flow"></use>
                                                    </svg>
                                                </section>
                                                <div>
                                                    <h2>
                                                    ...
                                                    <p>Incluye talleres de caminata conciente, meditacion, yoga y conexion con la naturaleza.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="extras__card">
                                            <div class="card__summary">
                                                ...
                                                <section>
                                                    <svg class="icon">
                                                        <use xlink:href="../assets/svg-resources.xml#icon-art"></use>
                                                    </svg>
                                                </section>
                                                <div>
                                                    <h2>
                                        ...
                                        <div class="extras__card">
                                            <div class="card__summary">
                                                ...
                                                <section>
                                                    <svg class="icon">
                                                        <use xlink:href="../assets/svg-resources.xml#icon-competition"></use>
                                                    </svg>
                                                </section>
                                                <div>
                                                    <h2>
                                                    ...
                                                    <p>Incluye organizacion de competencias de golf y actividades del casino.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
